...
{{ include "efs-provisioner.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "efs-provisioner.selectorLabels" -}}
app.kubernetes.io/name: {{ include "efs-provisioner.name" . }}
