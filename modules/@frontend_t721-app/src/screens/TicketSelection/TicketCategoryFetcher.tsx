        ...
        }
        {
            liveCategories.length > 0
                ...
                <>
                    ...
                    />
                    <TicketSelectionCta gradients={props.date.metadata.signature_colors} category={selection.category} clearSelection={() => setSelection({selection: null, category: null})}/>
                </>
