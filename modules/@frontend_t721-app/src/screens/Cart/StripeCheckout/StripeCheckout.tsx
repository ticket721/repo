...
export const StripeCheckout: React.FC<StripeCheckoutProps> = (props: StripeCheckoutProps): JSX.Element => {
    ...
    const submittable = isSubmittable(stripe, elements, fullName, cardNumber, cardCcv, cardExpiry);
    ...
    const handleSubmit = async () => {
        ...
        const { error } = await stripe.confirmCardPayment(authorizationData.clientSecret, {
            payment_method: {
                card: cardNumber,
                billing_details: {
                    name: fullName,
