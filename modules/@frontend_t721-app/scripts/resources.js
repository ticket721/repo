...
copyImages('resources/', TARGET_WEB_ICON, [{source: 'icon.png', target: 'logo-1024x1024.png'}]);
copyImages(SOURCE_ANDROID_ICON, TARGET_WEB_ICON, [{source: 'drawable-xxxhdpi-icon.png', target: 'logo-192x192.png'}]);
