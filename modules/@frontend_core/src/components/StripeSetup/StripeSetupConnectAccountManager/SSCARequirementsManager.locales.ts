...
i18n.addResourceBundle('en', 'stripe_setup_requirements', {
    title: 'Requirements',
    status: 'status',
    status__connect_account_currently_due: 'Action required',
    status__connect_account_eventually_due: 'Action required',
    status__connect_account_past_due: 'Action required',
    status__connect_account_pending_verification: 'Pending verification',
    status_ready: 'Ready',
    up_to_date: 'Up to date',
    click_to_update: 'Click to update your information >',
    document__connect_account_currently_due: 'Due Documents',
    document__connect_account_eventually_due: 'Due Documents',
...
i18n.addResourceBundle('fr', 'stripe_setup_requirements', {
    title: 'Pré-requis',
    status: 'status',
    status__connect_account_currently_due: 'Action requise',
