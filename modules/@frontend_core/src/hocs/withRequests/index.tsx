...
export type WithRequestsInjectedProps<TemplateInterfaceType extends RequestTemplate> = {
    responses: {
        readonly [P in keyof TemplateInterfaceType]: WithRequestsInjectedProp<
            ThenArg<ReturnType<TemplateInterfaceType[P]>>
        >;
    };
};
...
export const withRequests = <TemplateInterfaceType extends RequestTemplate, RestProps = any>(
    ...
    const WrapperComponent: React.FC<WithRequestsInputProps<TemplateInterfaceType> & RestProps> = function f({
        calls,
        responses,
        ...restProps
    }: WithRequestsInputProps<TemplateInterfaceType> &
        WithRequestsInjectedProps<TemplateInterfaceType> &
        RestProps): React.ReactElement<WithRequestsInjectedProps<TemplateInterfaceType> & RestProps> {
