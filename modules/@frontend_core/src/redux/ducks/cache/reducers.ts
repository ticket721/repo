...
const SetTickIntervalReducer: Reducer<CacheState, ISetTickInterval> =
    (state: CacheState, action: ISetTickInterval): CacheState => ({
        ...state,
        settings: {
            ...state.settings,
...
const SetIntervalIdReducer: Reducer<CacheState, ISetIntervalId> =
    (state: CacheState, action: ISetIntervalId): CacheState => ({
        ...state,
        settings: {
            ...state.settings,
...
const RegisterComponentReducer: Reducer<CacheState, IRegisterComponent> =
    (state: CacheState, action: IRegisterComponent): CacheState => {
...
const FetchItemReducer: Reducer<CacheState, IFetchItem> =
    (state: CacheState, action: IFetchItem): CacheState => ({
        ...state,
        properties: {
            ...state.properties,
            [action.key]: {
...
const UpdateLastResponseReducer: Reducer<CacheState, IUpdateLastResponse> =
    (state: CacheState, action: IUpdateLastResponse): CacheState => ({
        ...state,
        properties: {
            ...state.properties,
            [action.key]: {
...
const UpdateItemDataReducer: Reducer<CacheState, IUpdateItemData> =
    (state: CacheState, action: IUpdateItemData): CacheState => ({
        ...state,
        items: {
            ...state.items,
            [action.key]: {
...
const UpdateItemErrorReducer: Reducer<CacheState, IUpdateItemError> =
    (state: CacheState, action: IUpdateItemError): CacheState => ({
        ...state,
        items: {
            ...state.items,
            [action.key]: {
...
export const CacheReducer: Reducer<CacheState, CacheAction> =
    (state: CacheState = cacheInitialState, action: CacheAction): CacheState => {
        switch (action.type) {
