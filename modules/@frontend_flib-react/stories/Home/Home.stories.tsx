...
const featuredSlides = [
    {
        ...
        cover: 'assets/images/slide-1.jpg',
        price: '33',
    },
    {
        id: '2',
        ...
        text: 'Mon, Feb 16 8:30PM',
        cover: 'assets/images/slide-2.jpg',
        price: '33',
    },
    {
        id: '3',
...
export const showcase = () => (
    <div>
        <LocationHeader
            location={text('Current location', 'San Jose, CA')}
            title={text('Title', 'Browsing events in')}
        />
        <FeaturedCarousel slides={featuredSlides} />
        <CategoriesCarousel title={'Browse by categories'} slides={categoriesSlides} />
        <Container>
