...
export const showcase = () => {
    ...
    return (
        ...
        >
            <Button title={'success'} onClick={() => showToast('success')} variant={'primary'} />
            <Button title={'warning'} onClick={() => showToast('warning')} variant={'primary'} />
            <Button title={'error'} onClick={() => showToast('error')} variant={'primary'} />
            <Button title={'info'} onClick={() => showToast('info')} variant={'primary'} />
            <T721ToastContainer />
        </div>
    );
};
