...
`;
export const WalletPaymentTypes: React.FunctionComponent<WalletPaymentTypesProps> = (
    props: WalletPaymentTypesProps,
): JSX.Element => {
    return (
        <Container>
            <div className={'row aic jcsb'}>
                <RadioButton label={'Credit card'} name={'payment-type'} onChange={props.onChange} value={'cc'} />
