...
module.exports = {
    sealSale_expired: async function sealSale_expired() {
        ...
        await expect(MetaMarketplace.sealSale(id, uints, addr, bs)).to.eventually.be.rejectedWith('MM::sealSale | authorization expired');
    },
};
