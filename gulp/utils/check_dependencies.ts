...
export async function check_dependencies() {
    ...
    if (
        package_json.devDependencies['web3-provider-engine'] !== '15.0.7' ||
        package_json.devDependencies['@ledgerhq/hw-transport-node-hid'] !== '5.13.1' ||
        package_json.devDependencies['@ledgerhq/web3-subprovider'] !== '5.14.0' ||
        package_json.devDependencies['@ledgerhq/hw-app-eth'] !== '5.14.0' ||
        package_json.devDependencies['@ledgerhq/logs'] !== '5.13.1' ||
        package_json.devDependencies['@0x/subproviders'] !== '6.0.8'
    ) {
        console.error(`
