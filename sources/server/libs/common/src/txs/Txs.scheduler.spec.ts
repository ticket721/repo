...
describe('Txs Scheduler', function() {
    ...
    describe('blockPolling', function() {
        it('should update global config block number', async function() {
                    ...
                    hits: [
                        {
                            ...
                            _source: {
                                ...
                                from_:
                                    '0xea51bf51cdd20b0b7a65623992ecf516bb03a082',
                                gas_used: '1007437',
            ...
            when(
                context.txsServiceMock.searchElastic(deepEqual(esquery)),
            ).thenResolve({
                error: null,
        ...
        it('should fail on transaction update error', async function() {
            ...
            verify(
                context.shutdownServiceMock.shutdownWithError(
                    deepEqual(
                        new Error(
                            'TxsScheduler::blockPolling error while updating tx: unexpected_error',
                        ),
                    ),
                ),
            ).called();
    ...
    describe('transactionInitialization', function() {
        it('should initialize transaction', async function() {
                    ...
                    hits: [
                        {
                            ...
                            _type: 'tx',
                            _id:
                                '0xa6fac51ba2f29aa909077e27d6ec07584c39280835ab042bd0db7da0db41cc16',
                            _score: 1.3566749,
                            _source: {
            ...
            const txReceipt = {
                ...
                transactionIndex: 0,
                blockHash:
                    '0x0c79d5ba34bb38575e461e2c7548fd781dc2e6e798cfadf7341aa5e77aea12e1',
                blockNumber: 36,
                ...
                v: '0x153f',
                r:
                    '0x9a02c6a6e2d021e6dc5e168337e3fb8949f58e9bceadbaa6fdf0906489854409',
                s:
                    '0x23bc2af5f9c684f77bff0325976f76a4c634eb4dd76a81bdc42a990fd3d2065d',
            };
        ...
        it('should initialize transaction with contract creation', async function() {
            ...
            const txentity = {
                ...
                block_hash:
                    '0x0c79d5ba34bb38575e461e2c7548fd781dc2e6e798cfadf7341aa5e77aea12e1',
                contract_address: toAcceptedAddressFormat(
                    '0xea51bf51cdd20b0b7a65623992ecf516bb03a082',
                ),
                cumulative_gas_used: '1007501',
                cumulative_gas_used_ln: 19.942349840032083,
